...
namespace AdventOfCode2020.Tests
{
    public class Day07
    {
        ...
        {
            var output = await Solution07.ProblemOneAsync(WebsiteSample);
        ...
        {
            var output = await Solution07.ProblemTwoAsync(WebsiteSample);
        ...
        {
            var output = await Solution07.ProblemTwoAsync(WebsiteSampleTwo);
            Assert.Equal(126, output);
        }
    }
}
